                ...
                <div class="container-offer">
                    <div class="row">
                        <div class="business-offer col-12 col-md-6 col-xl-6">
                            <h1>
                                Страничка демонстрации
                                <span style="color: #7bc0e3">красивых фото</span>
                            </h1>
                            <p>
                ...
                <div class="row justify-content-center">
                    <div id="carousel" class="col-10 col-md-8 col-lg-6 carousel slide" data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            ...
                            <button type="button" data-bs-target="#carousel" data-bs-slide-to="8"
                                aria-label="Slide 9"></button>
                        </div>
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/1/slide1.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="images/1/slide2.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="images/1/slide3.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="images/1/slide4.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="images/1/slide5.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="images/1/slide6.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="images/1/slide7.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="images/1/slide8.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="images/1/slide9.png" class="d-block w-100" alt="...">
                            </div>
                        </div>
